...
const HeroNews = () => {
  ...
  return (
    <div className="lg:mt-[200px] mt-[50px] sm:mt-[100px] gap-y-4  w-[92%] mm:w-[88%] mx-auto ">
            ...
            index < 3 && (
              <div className="flex flex-col gap-y-4 my-shadow2 rounded-[5px]">
                ...
                <div className="flex flex-col gap-y-2 px-3 md:px-6">
                  ...
                  <p
                    className="text-slate-600 text-[18px] line-clamp-4 md:text-[21px] font-medium font-montserrat"
        ...
        >
          {news?.map((item, index) => (
            <SwiperSlide key={index}>
              <div className="flex flex-col gap-y-4 border shadow-md rounded-md rounded-[5px]">
                <div className="h-[321px]">
                  <img
                    src={url + item?.img}
                    alt="Rectangle 99.png"
                ...
                <div className="flex flex-col gap-y-2 px-3 md:px-6">
                  <p className="text-[21px] w-[90%] line-clamp-1 md:text-[26px] uppercase text-navcolor font-medium md:font-semibold font-montserrat border-b-[3px] border-b-mainColor">
                    {item?.title}
                  </p>
                  <p className="text-navcolor text-[18px] md:text-[21px] font-medium font-montserrat">
                    {moment(item?.date).format("YYYY.MM.DD")}
