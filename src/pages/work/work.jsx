  ...
  const getWorkData = async () => {
    try {
      ...
      const { data } = await axios.get(
        `${url}/a_admin_panel/api/jobs_category_list_views/`, config
      );
        ...
        <div class="rounded-sm  border-stroke bg-[#24303f] w-[98%] mx-auto px-5 pt-6 pb-2.5 shadow-default sm:px-7.5 xl:pb-1">
          <div class="max-w-full overflow-x-auto">
            <table class="w-full table-auto">
              ...
              {modals.add && (
                <AddWork getData={getWorkData} setIsOpen={setModals} />
              )}

              {modals.edit && (
                <EditWork getData={getWorkData} id={editId} setIsOpen={setModals} />
              )}

              {modals.delete && (
                <RemoveWork getData={getWorkData} setIsRemove={setModals} id={editId}/>
              )}
