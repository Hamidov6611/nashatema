...
const WeNews = () => {
  ...
  return (
    <UserLayout title={"Новости компании | Железобетонные изделия в Санкт-Петербурге и Лен области!"} desc={"Выбрать и купить железобетонные изделия в интернет-магазине вам поможет информация по размеру, весу, ценам, фото и другим характеристикам в каталоге товаров. Доставка по Санкт-Петербургу"}>
      <div className="lg:mt-[100px] mt-[188px] gap-y-4 min-h-[40vh] flex flex-col w-[92%] mm:w-[88%] mx-auto ">
        ...
        <div className="my-12 grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-x-4 gap-y-4">
          {news?.map((item, index) => (
            <div className="flex flex-col gap-y-4 my-shadow2 rounded-[5px]">
              ...
              <div className="flex flex-col gap-y-2 px-3 md:px-6">
                ...
                <p
                  className="text-slate-600 text-[18px] line-clamp-3 md:text-[21px] font-medium font-montserrat"
