...
import AddCategory from "../../Components/news/AddCategory";
import RemoveCategory from "../../Components/news/RemoveCategory";
import EditCategory from "../../Components/news/editCategory";
  ...
  const getData = async () => {
    try {
      const { data } = await axios.get(
        `${url}/a_admin_panel/api/news_list_views/?page=${pageId}`
      );
              ...
              <tbody>
                {category?.map((c, index) => (
                  <tr key={index}>
                    ...
                    <img src={`${url}${c?.img}`} alt="" className="w-[120px] h-[120px] rounded-md object-cover" />
