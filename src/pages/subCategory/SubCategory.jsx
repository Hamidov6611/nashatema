...
import RemoveCategory from "../../Components/subCategory/RemoveCategory";
import AddCategory from "../../Components/subCategory/AddCategory";
import EditCategory from "../../Components/subCategory/editCategory";
  ...
  const getData = async () => {
    try {
      const { data } = await axios.get(
        `${url}/a_admin_panel/api/category_list_views/?page=${pageId}`
      );
    ...
    <AdminLayout>
      <div className="min-h-[100vh] py-16 ">
        <div className=" w-[90%] lg:w-[98%] mx-auto mb-12 ml-[6%] sm:ml-[1%] items-center mt-2 flex justify-between">
          <p className="text-white font-semibold text-[20px]">Подкатегория</p>
          <IconButton
